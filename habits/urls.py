...
from habits.views import HabitCreateAPIView, HabitRetrieveAPIView, HabitListAPIView, HabitUpdateAPIView, \
    HabitDestroyAPIView, PublicHabitListAPIView

app_name = HabitsConfig.name
urlpatterns = [path("habits/create/", HabitCreateAPIView.as_view(), name="habits-create"),
